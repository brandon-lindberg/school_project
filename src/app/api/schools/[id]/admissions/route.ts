...
const admissionsSchema = z.object({
  ...
  admissions_breakdown_fees_grade_elementary_registration_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_elementary_registration_fee_jp: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_elementary_maintenance_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_elementary_maintenance_fee_jp: z.string().nullable().default(''),
  ...
  admissions_breakdown_fees_grade_junior_high_registration_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_junior_high_registration_fee_jp: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_junior_high_maintenance_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_junior_high_maintenance_fee_jp: z.string().nullable().default(''),
  ...
  admissions_breakdown_fees_grade_high_school_registration_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_high_school_registration_fee_jp: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_high_school_maintenance_fee_en: z.string().nullable().default(''),
  admissions_breakdown_fees_grade_high_school_maintenance_fee_jp: z.string().nullable().default(''),
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to update admissions information' },
      { status: 500 }
    );
  }
}
