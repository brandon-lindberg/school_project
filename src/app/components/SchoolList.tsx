            ...
            <div className="col-span-full divide-y divide-gray-200 max-h-[600px] overflow-y-auto scrollbar">
              {schools.map((school, index) => (
                <div
                  ...
                  className={`col-span-full grid grid-cols-[30px_minmax(200px,_1fr)_1fr_1fr_1fr_1fr_1fr_1fr_1fr] gap-4 px-4 py-3 cursor-pointer hover:bg-gray-50 relative ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'
                    }`}
