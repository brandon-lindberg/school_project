        ...
        <div className="relative flex-grow">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M21 21l-4.35-4.35M16.65 16.65A8 8 0 1 0 4 4a8 8 0 0 0 12.65 12.65z"
            />
          </svg>
        </div>
        <button
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div
              className={`transition-all duration-300 ease-in-out overflow-hidden ${isRegionExpanded ? 'max-h-[400px]' : 'max-h-0'}`}
            >
          ...
          <div className="flex flex-col">
            ...
            <div
              className={`transition-all duration-300 ease-in-out overflow-hidden ${isCurriculumExpanded ? 'max-h-60' : 'max-h-0'}`}
            >
